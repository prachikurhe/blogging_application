...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend Course", "This project is developed Rajshri And Prachi",
				"1.0", "Terms of Service",
				new Contact("Rajshri", "https://rajshribhoyar16@@gmail.com", "rajshribhoyar16@@gmail.com"),
